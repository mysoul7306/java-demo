...
springBoot.mainClass.set("kr.co.rokroot.java.demo.kafka.stream.service.StreamServiceInitializer")
description = "ROK_ROOT Java Demo Kafka Stream Service module"
...
tasks {
    bootJar {
        archiveFileName = "kafka-stream-service.jar"
    }
    processResources {
