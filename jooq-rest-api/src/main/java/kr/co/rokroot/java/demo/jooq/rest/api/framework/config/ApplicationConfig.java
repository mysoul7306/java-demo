...
import kr.co.rokroot.java.demo.jooq.rest.api.framework.config.jooq.MariaDBJooqConfig;
...
@Configuration
@ComponentScan(basePackages = {"kr.co.rokroot.java.demo.jooq.rest.api.module"},
...
public class ApplicationConfig {
    ...
    @Bean(name = "apiClient")
    public WebClient apiClient() throws SSLException {
